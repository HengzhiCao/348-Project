        ...
        try
        {
            ...
            while(true)
            {
                try
                {
                    ...
                    // Listing for request 不知道为什么listening 在这里不能用了
//                    status.setText("[Host Player]:\t"+serverSocket+" listening");

                    clientSocket=server.accept();
                    status.setText(" Now Connected to "+clientSocket.getInetAddress().getHostName());
...
//                    PlayerListener listener = new PlayerListener(clientSocket);
//                    PlayerSender sender = new PlayerSender(clientSocket);
//
//                    // listing and sending
//                    listener.start();
//                    sender.start();
