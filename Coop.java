...
public class Coop extends javax.swing.JFrame {
    ...
    public Coop(String s) {

        initComponents();

        this.setTitle("Coop Client");
...
//            PlayerListener listener = new PlayerListener(s);
//            PlayerSender sender = new PlayerSender(s);
//
//            // listing and sending
//            listener.start();
//            sender.start();
